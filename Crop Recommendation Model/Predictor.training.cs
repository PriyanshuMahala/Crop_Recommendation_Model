...
namespace Crop_Recommendation_Model
{
    public partial class Predictor
    {
        ...
        public static void Train(string outputModelPath, string inputDataFilePath = RetrainFilePath,
            char separatorChar = RetrainSeparatorChar, bool hasHeader = RetrainHasHeader,
        ...
        public static IDataView LoadIDataViewFromFile(MLContext mlContext, string inputDataFilePath, char separatorChar,
            bool hasHeader, bool allowQuoting)
        {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new[]
                {
                    new InputOutputColumnPair(@"N", @"N"), new InputOutputColumnPair(@"P", @"P"),
                    new InputOutputColumnPair(@"K", @"K"), new InputOutputColumnPair(@"temperature", @"temperature"),
                    new InputOutputColumnPair(@"humidity", @"humidity"), new InputOutputColumnPair(@"ph", @"ph"),
                    new InputOutputColumnPair(@"rainfall", @"rainfall")
                })
                .Append(mlContext.Transforms.Concatenate(@"Features",
                    new[] { @"N", @"P", @"K", @"temperature", @"humidity", @"ph", @"rainfall" }))
                .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: @"label",
                    inputColumnName: @"label", addKeyValueAnnotationsAsText: false))
